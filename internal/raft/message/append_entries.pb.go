...
type AppendEntriesRequest struct {
	...
	Entries      []*LogData `protobuf:"bytes,5,rep,name=Entries,proto3" json:"Entries,omitempty"`            // Entries are the log entries in the node.
	LeaderCommit int32      `protobuf:"varint,6,opt,name=leaderCommit,proto3" json:"leaderCommit,omitempty"` // LeaderCommit is the Leader's commit index.
}
...
type LogData struct {
	...
	Term  int32    `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"`
	Entry *Command `protobuf:"bytes,2,opt,name=Entry,proto3" json:"Entry,omitempty"` // Each is a compiled sql stmt
}
...
func (x *LogData) GetEntry() *Command {
	if x != nil {
		return x.Entry
	}
	return nil
...
type AppendEntriesResponse struct {
	...
	Term    int32 `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"`       // Term is the responder node's current term.
	Success bool  `protobuf:"varint,2,opt,name=success,proto3" json:"success,omitempty"` // Success returns true if the log matching property holds good.
}
...
var file_append_entries_proto_rawDesc = []byte{
	...
	0x0d, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdc,
	...
	0x65, 0x61, 0x64, 0x65, 0x72, 0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x6c,
	0x65, 0x61, 0x64, 0x65, 0x72, 0x49, 0x44, 0x12, 0x22, 0x0a, 0x0c, 0x70, 0x72, 0x65, 0x76, 0x4c,
	...
	0x07, 0x45, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10,
	0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x4c, 0x6f, 0x67, 0x44, 0x61, 0x74, 0x61,
	0x52, 0x07, 0x45, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x12, 0x22, 0x0a, 0x0c, 0x6c, 0x65, 0x61,
	...
	0x07, 0x4c, 0x6f, 0x67, 0x44, 0x61, 0x74, 0x61, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x65, 0x72, 0x6d,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x74, 0x65, 0x72, 0x6d, 0x12, 0x26, 0x0a, 0x05,
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x52, 0x05, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x22, 0x45, 0x0a, 0x15, 0x41, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x45, 0x6e,
...
var file_append_entries_proto_depIdxs = []int32{
	...
	3, // 1: message.LogData.Entry:type_name -> message.Command
